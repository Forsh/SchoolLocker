...
public class ContentGroupFragment extends Fragment {
    ...
    /**
     * @return a new instance of {@link com.zfakgroup.israel.schoollocker.ContentGroupFragment}, adding the parameters into a bundle and
        ...
        listCourseAsync.execute(new AsyncCallback() {
            ...
            public void callback(Object result) {
                if (result instanceof List) {
                    ...
                    ((ListView) view.findViewById(R.id.groupCourseList)).setAdapter(new MyGroupsAdapter(getActivity(), R.layout.search_item, groups));
                }
            }
        });
