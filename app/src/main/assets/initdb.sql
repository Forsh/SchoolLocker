...
(Id integer PRIMARY KEY AUTOINCREMENT,  Name text, Description text, Beginning text, Ending text);

CREATE TABLE GROUPS
(Id integer PRIMARY KEY AUTOINCREMENT,  Name text, Description text);

CREATE TABLE UNIVERSITIES
(Id integer PRIMARY KEY AUTOINCREMENT,  Name text, Description text, Adress text);
...
CREATE TABLE GROUPSINUNIVERSITIES
(GroupId integer NOT NULL, UniversityId integer NOT NULL,
FOREIGN KEY(GroupId) REFERENCES GROUPS(Id),
FOREIGN KEY(UniversityId) REFERENCES UNIVERSITIES(Id));

CREATE TABLE COURSESINUNIVERSITIES
(CourseId integer NOT NULL, UniversityId integer NOT NULL,
FOREIGN KEY(CourseId) REFERENCES COURSES(Id),
FOREIGN KEY(UniversityId) REFERENCES UNIVERSITIES(Id));

CREATE TABLE FILESINCOURSES
(FileId integer NOT NULL, CourseId integer NOT NULL,
FOREIGN KEY(CourseId) REFERENCES COURSES(Id),
FOREIGN KEY(FileID) REFERENCES CONTENTS(Id));

CREATE TABLE GROUPSINCOURSES
(GroupId integer NOT NULL, CourseId integer NOT NULL,
FOREIGN KEY(GroupId) REFERENCES GROUPS(Id),
FOREIGN KEY(CourseId) REFERENCES COURSES(Id));

CREATE TABLE USERSINGROUPS
(UserId integer NOT NULL, GroupId integer NOT NULL, Rights integer,
FOREIGN KEY(GroupId) REFERENCES GROUPS(Id),
FOREIGN KEY(UserId) REFERENCES USERS(Id));

CREATE TABLE USERSINCOURSES
(UserId integer NOT NULL, CourseId integer NOT NULL, Rights integer,
FOREIGN KEY(UserId) REFERENCES USERS(Id),
FOREIGN KEY(CourseId) REFERENCES COURSES(Id));
